...
from keras.layers import Input, Add, Dense, Activation, Flatten, Convolution2D, MaxPooling2D,BatchNormalization,ZeroPadding2D, \
...
def nn_base(input_tensor=None, trainable=False):   ### basic resnet architecture
...
def rpn(base_layers,num_anchors):
    ...
    # base resnet passed in and adding 1 more convolution layer to it and further dividing it as 2 architectures: 
    # rpn_classification -  add one more convolution layer - activation='sigmoid', kernel_initializer='uniform'
    # rpn_regression - add one more convolution layer - activation='linear', kernel_initializer='zero'
...
def classifier(base_layers, input_rois, num_rois, nb_classes = 21, trainable=False):
    ...
    # regression dense output is = 4 values of bounding box co-ordinates
